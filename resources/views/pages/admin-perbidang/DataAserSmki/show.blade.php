            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
                    ...
                    @if($asset->status_verifikasi === 'Terverifikasi')
                        <a href="{{ route('qr.asset.show', ['smki', $asset->id]) }}" target="_blank" class="inline-flex w-full items-center justify-center bg-[#0F3092] hover:bg-[#0B2F83] text-white text-xs font-bold uppercase tracking-wider px-4 py-3 rounded-xl transition-colors">
                            Lihat Detail QR
                        </a>
                    @else
