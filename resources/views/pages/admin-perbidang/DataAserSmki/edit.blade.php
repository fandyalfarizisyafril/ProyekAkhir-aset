                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            >
                                <option value="Aktif" {{ old('status_verifikasi', $asset->status_verifikasi) === 'Aktif' ? 'selected' : '' }}>Aktif</option>
                                <option value="Maintenance" {{ old('status_verifikasi', $asset->status_verifikasi) === 'Maintenance' ? 'selected' : '' }}>Maintenance</option>
                                <option value="Rusak" {{ old('status_verifikasi', $asset->status_verifikasi) === 'Rusak' ? 'selected' : '' }}>Rusak</option>
                            </select>
                            <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-4 text-slate-400">
                                <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
