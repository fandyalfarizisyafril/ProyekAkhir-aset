<x-app-layout>
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        ...
        <div class="flex items-center space-x-3 w-full sm:w-auto">
            <a href="{{ route('admin-perbidang.data-aset-smki.export', request()->query()) }}" class="w-1/2 sm:w-auto bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 text-xs font-bold uppercase tracking-wider px-5 py-3 rounded-xl flex items-center justify-center space-x-2 transition-all duration-150 shadow-sm">
                <!-- Export Icon -->
                        ...
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            ...
                            <td class="py-4 px-4 text-center">
                                <div class="flex items-center justify-center space-x-3">
                                    ...
                                    <a href="{{ route('admin-perbidang.data-aset-smki.show', $asset->id) }}" class="text-slate-400 hover:text-slate-600 transition-colors p-1 hover:bg-slate-100 rounded" title="Detail Aset">
