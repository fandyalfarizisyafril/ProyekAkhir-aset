<x-app-layout>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <!-- TOTAL CARD -->
        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 flex items-center justify-between transition-all duration-200 hover:shadow-md">
            <div class="flex items-center space-x-4">
                <div class="h-14 w-14 bg-slate-50 border border-slate-100 rounded-2xl flex items-center justify-center flex-shrink-0">
            ...
            <div class="text-[10px] font-bold text-slate-400 uppercase self-start">
                TOTAL
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 flex items-center justify-between transition-all duration-200 hover:shadow-md">
            <div class="flex items-center space-x-4">
                <div class="h-14 w-14 bg-[#EBFDF5] rounded-2xl flex items-center justify-center flex-shrink-0">
                    <svg class="h-7 w-7 text-[#10B981]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                    </svg>
                </div>
                <div class="flex flex-col">
                    <span class="text-3xl font-extrabold text-slate-800 tracking-tight">
                        {{ number_format($baikCount) }}
                    </span>
                    <span class="text-xs font-semibold text-slate-400 mt-0.5">
                        <strong class="text-[#10B981] font-bold">{{ number_format($persenBaik, 1) }}%</strong> Total aset
                    </span>
                </div>
            </div>
            <div class="text-[10px] font-bold text-[#10B981] uppercase self-start">
                KONDISI BAIK
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 flex items-center justify-between transition-all duration-200 hover:shadow-md">
            <div class="flex items-center space-x-4">
                <div class="h-14 w-14 bg-[#FEF3C7] rounded-2xl flex items-center justify-center flex-shrink-0">
                    <svg class="h-7 w-7 text-[#D97706]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                    </svg>
                </div>
                <div class="flex flex-col">
                    <span class="text-3xl font-extrabold text-slate-800 tracking-tight">
                        {{ number_format($rusakRinganCount) }}
                    </span>
                    <span class="text-xs font-semibold text-slate-400 mt-0.5">
                        <strong class="text-[#D97706] font-bold">{{ number_format($persenRusakRingan, 1) }}%</strong> Butuh servis
                    </span>
                </div>
            </div>
            <div class="text-[10px] font-bold text-[#D97706] uppercase self-start">
                RUSAK RINGAN
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 flex items-center justify-between transition-all duration-200 hover:shadow-md">
            <div class="flex items-center space-x-4">
                <div class="h-14 w-14 bg-[#FEE2E2] rounded-2xl flex items-center justify-center flex-shrink-0">
                    <svg class="h-7 w-7 text-[#EF4444]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                </div>
                <div class="flex flex-col">
                    <span class="text-3xl font-extrabold text-slate-800 tracking-tight">
                        {{ number_format($rusakBeratCount) }}
                    </span>
                    <span class="text-xs font-semibold text-slate-400 mt-0.5">
                        <strong class="text-[#EF4444] font-bold">{{ number_format($persenRusakBerat, 1) }}%</strong> Penghapusan
                    </span>
                </div>
            </div>
            <div class="text-[10px] font-bold text-[#EF4444] uppercase self-start">
                RUSAK BERAT
            </div>
        </div>
    </div>
