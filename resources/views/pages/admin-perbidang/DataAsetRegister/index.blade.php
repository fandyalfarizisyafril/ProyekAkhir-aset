                        ...
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            ...
                            <td class="py-4 px-4 text-center">
                                <div class="flex items-center justify-center space-x-3">
                                    <!-- View/Detail Icon -->
                                    <a href="{{ route('admin-perbidang.data-aset-register.edit', $asset->id) }}" class="text-slate-400 hover:text-slate-600 transition-colors p-1 hover:bg-slate-100 rounded" title="Detail Aset">
                                    ...
                                    <!-- Delete Link -->
                                    <form action="{{ route('admin-perbidang.data-aset-register.destroy', $asset->id) }}" method="POST" class="inline delete-form" data-asset-name="{{ $asset->nama_aset }}">
                                        @csrf
                                        @method('DELETE')
