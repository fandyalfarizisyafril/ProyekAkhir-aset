        ...
        <div class="lg:col-span-2 bg-white rounded-2xl border border-slate-200 shadow-sm p-6 space-y-6">
            <div class="flex justify-between items-center border-b border-slate-100 pb-4">
                <h3 class="text-base font-bold text-slate-800 flex items-center space-x-2">
                    ...
                    <span>Form Detail Akun Pegawai</span>
                </h3>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-blue-50/50 rounded-2xl border border-blue-100 p-6 space-y-3">
                ...
                <p class="text-slate-600 text-xs font-medium leading-relaxed">
                    Kredensial pengguna akan dienkripsi secara aman dan tercatat pada log audit akses sistem Diskominfotik Riau.
                </p>
            </div>

            <!-- Panduan Keamanan Card -->
                ...
                <div class="space-y-3">
                    <div class="flex items-start space-x-3 text-xs text-slate-600">
                        ...
                        <p class="leading-relaxed">
                            NIP harus bernilai unik untuk setiap pegawai yang terdaftar.
                        </p>
                    </div>
                    ...
                    <div class="flex items-start space-x-3 text-xs text-slate-600">
                        ...
                        <p class="leading-relaxed">
                            Gunakan format email dinas resmi yang aktif milik pegawai.
                        </p>
                    </div>
                    ...
                    <div class="flex items-start space-x-3 text-xs text-slate-600">
                        ...
                        <p class="leading-relaxed">
                            Kata sandi akun minimal terdiri dari 8 karakter unik.
                        </p>
                    </div>
                </div>
            </div>
