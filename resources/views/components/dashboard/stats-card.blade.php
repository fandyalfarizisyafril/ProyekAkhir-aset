...
<div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 flex items-center space-x-4 transition-all duration-200 hover:shadow-md">
    <!-- Icon Container -->
    <div class="h-16 w-16 {{ $bgIcon }} rounded-2xl flex items-center justify-center flex-shrink-0">
        @if($type === 'success')
            <!-- Shield Check / Approved Icon -->
            <svg class="h-8 w-8 {{ $iconColor }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <div class="flex flex-col">
        ...
        <span class="text-3xl font-extrabold text-slate-800 tracking-tight my-1">
            {{ $value }}
        </span>
